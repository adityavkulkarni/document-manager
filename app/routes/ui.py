...
def view_pdf(pdf_id):
    ...
    tmp_path = os.path.join(current_app.config['TMP_DIRECTORY'], pdf.original_filename)
    static_path = os.path.join(current_app.config['STATIC_DIRECTORY'], pdf.original_filename)
